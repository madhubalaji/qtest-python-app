...
class TestTaskService:
    ...
    def test_task_service_initialization_with_existing_file(self, temp_storage_file):
        """Test TaskService initialization with existing storage file."""
    ...
    def test_update_task_title(self, populated_task_service):
        ...
        assert updated_task.description == "Description 1"  # Should remain unchanged
    ...
    def test_update_task_non_existing(self, populated_task_service):
        ...
        with pytest.raises(TaskNotFoundException):
            populated_task_service.update_task(999, title="Won't work")
    ...
    def test_search_tasks_partial_match(self, populated_task_service):
        ...
        assert len(results) == 3  # Should find all tasks containing "Task"
    ...
    def test_persistence_after_operations(self, temp_storage_file):
        """Test that tasks are persisted to file after operations."""
