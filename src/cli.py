...
def _handle_add_command(task_service, args):
...
def _handle_list_command(task_service, args):
...
def _handle_view_command(task_service, args):
...
def main():
    ...
    try:
        if args.command == "add":
            _handle_add_command(task_service, args)
        elif args.command == "list":
            _handle_list_command(task_service, args)
        elif args.command == "complete":
            _handle_complete_command(task_service, args)
        elif args.command == "delete":
            _handle_delete_command(task_service, args)
        elif args.command == "search":
            _handle_search_command(task_service, args)
        elif args.command == "view":
            _handle_view_command(task_service, args)
        else:
            parser.print_help()
